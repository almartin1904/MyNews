...
public class NYTArticleTest {
    ...
    public void testGetTitleApiTopStories(){
        NYTArticle nytArticleTopStories = new NYTArticle(NYTArticle.API_TOP_STORIES, TITLE, URL, PUBLISHED_DATE, SECTION, SUBSECTION, IMAGE_URL);
        assertEquals(TITLE, nytArticleTopStories.getTitle());
    }

    @Test
    public void testGetTitleApiMostPopular(){
        NYTArticle nytArticleTopStories = new NYTArticle(NYTArticle.API_MOST_POPULAR, TITLE, URL, PUBLISHED_DATE, SECTION, SUBSECTION, IMAGE_URL);
        assertEquals(TITLE, nytArticleTopStories.getTitle());
    }

    @Test
    public void testGetTitleApiSearchArticle(){
        NYTArticle nytArticleTopStories = new NYTArticle(NYTArticle.API_ARTICLE_SEARCH, TITLE, URL, PUBLISHED_DATE, SECTION, SUBSECTION, IMAGE_URL);
        assertEquals(TITLE, nytArticleTopStories.getTitle());
    }
    ...
    public void testGetPublishedDateApiTopStories(){
        NYTArticle nytArticleTopStories = new NYTArticle(NYTArticle.API_TOP_STORIES, TITLE, URL, "2018-12-19T09:09:22-05:00", SECTION, SUBSECTION, IMAGE_URL);
        assertEquals("19/12/2018", nytArticleTopStories.getPublishedDate());
    }

    @Test
    public void testGetPublishedDateApiMostPopular(){
        NYTArticle nytArticleTopStories = new NYTArticle(NYTArticle.API_MOST_POPULAR, TITLE, URL, "2018-12-12", SECTION, SUBSECTION, IMAGE_URL);
        assertEquals("12/12/2018", nytArticleTopStories.getPublishedDate());
    }

    @Test
    public void testGetPublishedDateApiSearchArticle(){
        NYTArticle nytArticleTopStories = new NYTArticle(NYTArticle.API_ARTICLE_SEARCH, TITLE, URL, "1927-04-06T00:00:00Z", SECTION, SUBSECTION, IMAGE_URL);
